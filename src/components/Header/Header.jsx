    ...
    <header className={styles.header}>
      ...
      <ul className={`${styles.nav} ${navActive ? styles.active : ""}`}>
        <li className={styles.nav__item}>
          <Link className={styles.nav__link} to="/">Trang chủ</Link>
        </li>
        <li className={styles.nav__item}>
          <Link className={styles.nav__link} to="/food">Ẩm thực</Link>
        </li>
        <li className={styles.nav__item}>
          <Link className={styles.nav__link} to="/convenient">Tiện Ích</Link>
        </li>
        <li className={styles.nav__item}>
          <Link className={styles.nav__link} to="/blog">Blog</Link>
        </li>
        <li className={styles.nav__item}>
          <Link className={styles.nav__link} to="/endow">Ưu Đãi</Link>
        </li>
        <li className={styles.nav__item}>
          <Link className={styles.nav__link} to="/view-room">Xem Phòng</Link>
        </li>
        <li className={styles.nav__item}>
          <Link className={styles.nav__link} to="/contact">Liên hệ</Link>
        </li>
        ...
        {isLoggedIn ? (
          <>
            ...
            <li className={styles.nav__item}>
              <button className={styles.nav__link} onClick={handleLogout} style={{ background: "none", border: "none", cursor: "pointer" }}>
                Đăng xuất
              </button>
            </li>
          </>
          ...
          <>
            <li className={styles.nav__item}>
              <Link className={styles.nav__link} to="/login">Đăng nhập</Link>
            </li>
            <li className={styles.nav__item}>
              <Link className={styles.nav__link} to="/signup">Đăng ký</Link>
            </li>
          </>
        )}
      </ul>
